...
export function WithdrawalHistory() {
  ...
  useEffect(() => {
    apiClient.get('/wallet/withdrawals').then((res: any) => setItems(res.data || [])).catch(() => {}).finally(() => setIsLoading(false));
  }, []);
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                {items.map((w) => (
                  <tr key={w.id}>
                    ...
                    <td className="px-6 py-3 text-gray-600 dark:text-gray-400">{w.method}</td>
