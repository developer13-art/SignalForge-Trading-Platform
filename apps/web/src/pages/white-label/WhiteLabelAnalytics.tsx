...
import { UsersIcon, SignalIcon, AnalyticsIcon, DollarIcon } from '../../components/ui/icons';

export function WhiteLabelAnalytics() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">White Label Analytics</h1>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Analytics for your white label platform
        </p>
      </div>
